...
type
  ...
  protected
    ...
    function GetConnected: Boolean; virtual; abstract; //Socket or COM ports have Connected override
...
begin
  ...
  try
    ...
    begin
      ...
      if ((c = 0) and Passive) or not Connected or not CanRead or ((Count > 0) and (Size = 0)) then
        break;
    end;
  finally
    FreeMem(aBuffer);

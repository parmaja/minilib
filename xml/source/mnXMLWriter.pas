...
procedure TmnCustomXMLWriter.WriteOpenTag(Name: string; const Attributes: string);
begin
...
{procedure TmnCustomXMLWriter.Write(const Name, Value: string; const Attributes: string);
var
  s: string;
begin
  if Smart and (Tabs <> '') then
